// Importers/callers: mounted by apps/portal/src/routes/config.ts and apps/portal/src/routes/index.tsx
...
import { Card, CardContent, CardDescription, CardHeader } from '@fluxeme/ui/card';
...
import { usePublishedAnnouncements } from '@/api/announcements';
