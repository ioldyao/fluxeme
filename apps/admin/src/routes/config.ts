...
export const adminRoutes: RouteConfig[] = [
  { index: true, path: '/', Component: lazy(() => import('@/pages/FlowControlTower')), guard: 'admin', label: 'nav.flowControl', icon: Radio, nav: true, end: true, perm: 'admin:dashboard' },
  { path: '/flow-control', Component: lazy(() => import('@/pages/FlowControlTower')), guard: 'admin', perm: 'admin:dashboard' },
  ...
  { path: '/models', Component: lazy(() => import('@/pages/Models')), guard: 'admin', label: 'nav.models', icon: Cpu, nav: true, perm: 'admin:models' },
  ...
  { path: '/profile', Component: lazy(() => import('@/pages/Profile')), guard: 'admin', label: 'nav.profile', icon: User, nav: true },
];
