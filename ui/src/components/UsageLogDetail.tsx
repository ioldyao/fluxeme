        ...
        {isLoading ? (
          ...
          <div className="space-y-4 min-w-0">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 min-w-0">
              ...
              {record.client_ip && (
                <div className="rounded-lg border p-3 space-y-1">
                  <div className="text-[10px] uppercase tracking-wider text-muted-foreground">{t('usage.clientIp')}</div>
                  <div className="font-medium font-mono text-xs">{record.client_ip}</div>
                </div>
              )}
              <div className="rounded-lg border p-3 space-y-1">
