...
export interface UsageRequestAttempt { attempt_no: number; channel_id?: string | null; endpoint_id?: number | null; endpoint_url?: string | null; provider?: string | null; status_code?: number | null; success: number; timeout: number; error?: string | null; latency_ms: number; }
