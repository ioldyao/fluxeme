...
export interface UsageRequest {
  timestamp: string | number; request_id: string; user_id?: string | null; user_name?: string | null; team_id?: string | null; api_key_name?: string | null; api_format: string; method?: string; path?: string; stream: number; request_body?: string | null; response_body?: string | null; client_ip?: string | null; requested_model: string; resolved_model?: string | null; model_mapping_rule?: string | null; model?: string; success?: boolean; latency_ms?: number; cache_hit_input_tokens?: number; channel_id?: string | null; endpoint_id?: number | null; endpoint_url?: string | null; status: string; status_code: number; error_stage?: string | null; error_kind?: string | null; error_message?: string | null; attempt_count: number; successful_attempt?: number | null; prompt_tokens: number; completion_tokens: number; cache_read_tokens: number; cache_write_tokens: number; total_tokens: number; total_latency_ms: number; ttft_ms?: number | null; client_disconnected: number; billing_payment_mode?: string | null;
}
