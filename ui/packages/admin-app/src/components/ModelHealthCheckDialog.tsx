...
import { useModelHealthCheck } from '@fluxeme/shared/src/api/models';
...
import type { Model, ModelHealthCheckResult, Endpoint, ProbeResult } from '@fluxeme/shared/src/types';
