...
import { useFilterRules, useCreateFilterRule, useUpdateFilterRule, useDeleteFilterRule } from '@fluxeme/shared/src/api/moderation';
...
import type { ContentFilterRule } from '@fluxeme/shared/src/types';
