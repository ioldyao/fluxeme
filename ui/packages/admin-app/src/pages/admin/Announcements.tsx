...
import { useAnnouncements, useCreateAnnouncement, useUpdateAnnouncement, useDeleteAnnouncement } from '@fluxeme/shared/src/api/announcements';
import type { Announcement } from '@fluxeme/shared/src/api/announcements';
