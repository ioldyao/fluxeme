...
function sourceLabel(source: string): string {
  return { package: '资源包', wallet: '钱包', package_and_wallet: '资源包 + 钱包', postpaid: '预付费', postpaid_package: '预付费 + 资源包', free_model: '免费模型', none: '无扣费', zero_cost: '零金额', unknown: '待确认' }[source] ?? source;
}
