...
import { useFilterRules, useCreateFilterRule, useUpdateFilterRule, useDeleteFilterRule } from '@shared/api/moderation';
...
import type { ContentFilterRule } from '@shared/types';
