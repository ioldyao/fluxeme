...
export type RouteGuard = 'public' | 'admin';
...
export interface RouteConfig {
  ...
  /** Fine-grained Casbin permission required. */
  perm?: Permission;
}
...
export const adminRoutes: RouteConfig[] = [
  { path: '/flow-control', Component: lazy(() => import('@/pages/FlowControlTower')), guard: 'admin', label: 'nav.flowControl', icon: Radio, nav: true, end: true, perm: 'admin:dashboard' },
